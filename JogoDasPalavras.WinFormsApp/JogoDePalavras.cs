...
namespace JogoDasPalavras.WinFormsApp
{
    public class JogoDePalavras
    {
        ...
        public string ObterPalavraSecreta()
        {
            ...
            int numeroAleatorio = gerarNumeroAleatorio.Next(0, palavrasSecretas.Length);

            return palavraSecreta = palavrasSecretas[numeroAleatorio].ToUpper();
        }

        public bool ComparaSeGanhou()
        {
            if (palavraSecreta == palavraCorreta)
                return true;

            return false;
        }

        public bool ComparaSePerdeu()
        {
            if (contador == 4)
                return true;
        ...
        public bool VerificaSePalavraEstaCompleta()
        {
            if (palavraCorreta.Length == 5)
                return true;
        ...
        public bool CompararLetrasIguais(char letra1, char letra2)
        {
